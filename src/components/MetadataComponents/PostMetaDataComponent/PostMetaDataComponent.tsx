...
export default function PostMetadataComponent(props: RIRegular) {
    const {
    ...
    return (
        <div className="flex justify-between">
            <div className="flex flex-row my-auto">
                ...
                <div className="flex">
                    <div className="mx-2 flex-row">
                        <div className="font-medium text-xs">Chirag Goel</div>
            ...
            <div className="font-medium text-sm">
                <SystemButtons.Regular>Like</SystemButtons.Regular>
                <div />
            </div>
        </div>
    );
